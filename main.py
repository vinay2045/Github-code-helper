...
github_token = st.text_input("GitHub Token", value=default_github_token, type="password")
github_username = st.text_input("GitHub Username", value=default_github_username)

# Initialize the Gemini-powered agent using the provided API key
agent = Agent(
    name="GitHub Fixer",
